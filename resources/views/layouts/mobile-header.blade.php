...
{{--                                <img src="{{URL::asset('assets/images/brand/e-Aduan-logo.png')}}" class="header-brand-img desktop-logo" alt="logo">--}}
                                <img src="@if(systemGeneralSetting() != null && systemGeneralSetting()->logo != null) {{asset('storage/image/logo/'.systemGeneralSetting()->logo)}} @else {{URL::asset('assets/images/brand/antaraDesk-logo.png')}} @endif" class="header-brand-img desktop-logo mobile-light" alt="logo">
                            </a>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        <div class="drop-heading">
                                            <div class="text-center">
                                                <h5 class="text-dark mb-0">{{$current_user->name}}</h5>
                                                <small class="text-muted">@if($current_user->isadmin == 1) Administrator @else Staff @endif</small>
                                            </div>
                                        </div>
