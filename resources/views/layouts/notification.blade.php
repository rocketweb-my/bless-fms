...
{{--									</div>--}}
								...
								<div class="dropdown profile-1">
									<a href="#" data-toggle="dropdown" class="nav-link pr-2 leading-none d-flex">
										<span>
											<img src="@if($current_user->profile_picture) {{asset('storage/profile_pic/'.$current_user->profile_picture)}} @else {{URL::asset('assets/images/users/10.jpg')}} @endif" alt="profile-user" class="avatar  profile-user brround cover-image">
										</span>
									</a>
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
