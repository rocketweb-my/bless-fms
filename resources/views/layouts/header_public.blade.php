...
{{--							<a class="animated-arrow hor-toggle horizontal-navtoggle"><span></span></a>--}}
							<div class="">
								<a class="header-brand1" href="{{ url('/') }}">
									<img src="@if(systemGeneralSetting() != null && systemGeneralSetting()->logo_public != null) {{asset('storage/image/logo_public/'.systemGeneralSetting()->logo_public)}} @else {{URL::asset('assets/images/brand/antaraDesk-logo.png')}} @endif" class="header-brand-img desktop-logo" style="height: auto !important;" alt="logo">
